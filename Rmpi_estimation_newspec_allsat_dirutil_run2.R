...
load("D:/segnet/results/estimation/Rmpi_estimation_newspec_allsat_dirutil_run1.RData")

# use mean of Theta as starting value
theta.start <- as.numeric(colMeans(Theta[4000:5000,]))
qq <- cov(Theta[4000:5000,])
...
save.image("D:/segnet/results/estimation/Rmpi_estimation_newspec_allsat_dirutil_run2.RData")