...
load("D:/segnet/results/estimation/Rmpi_estimation_newspec_allsat_run2.RData")
...
save.image("D:/segnet/results/estimation/Rmpi_estimation_newspec_allsat_run3.RData")