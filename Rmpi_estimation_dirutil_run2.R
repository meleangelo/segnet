...
load("D:/segnet/results/estimation/Rmpi_estimation_dirutil_run1.RData")
...
number_param_simulations <- 100000
...
save.image("D:/segnet/results/estimation/Rmpi_estimation_dirutil_run2.RData")
